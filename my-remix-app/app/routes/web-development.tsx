  ...
  return (
    <>
      ...
      <section className="m-[50px] h-auto px-[50px] py-[30px] rounded-2xl">
        ...
        <div className="sm:grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4">
              ...
              <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <div className="p-5">
                  ...
                  <p className="mb-3 text-sm font-normal text-gray-700 dark:text-gray-400 text-left">
                    <b>Purpose: A fun personal project</b>
                    <br /> <b>Whats it about?:</b> <br /> Not sure what to make
                    for dinner? The Meal App is just for you. It utilizes the
                    Meal API to generate random meal suggestions or you can
                    simply browse the database for whatever your taste buds
                    desire! (Hmm maybe I have a future in copywriting lol)
                    Tools: React, Tailwind CSS, React Router v6 Check out the
                    readme for whats to come
                  </p>
                  <Link
                    to="https://mealappbysb.netlify.app/"
                    target="_blank"
                    rel="noreferrer"
